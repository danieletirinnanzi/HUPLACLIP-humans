...
with open('degree distribution matching/couple of graphs/matplotlib/currentComparisonObject_coupleOfGraphs.json') as current_comparison_file:
...
plt.plot(x, y_without_clique, label="Graphs without clique")
