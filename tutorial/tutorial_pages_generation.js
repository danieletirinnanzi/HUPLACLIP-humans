    ...
    */
    ...
    for (let index = 1; index < Object.keys(instructionsObject).length; index++) {
        ...
        if (index === 33) {
            ...
            <img src="tutorial/${currentExperiment.pCorrectionType}/instructions_images/${instructionsObject[index + 1][1]}.PNG" alt="Could not upload image" width="${currentExperiment.canvasDimensions[1]}" ><br><br>
            ${instructionsObject[index + 1][0]}<br><br>
            <i><b>< Press left arrow to go back <br></b></i>
            <i><b>Press right arrow to go forward ></b></i>
            `;
