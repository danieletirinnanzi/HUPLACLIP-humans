...
function generateIntroductionPages() {
    ...
    */
    ...
    <br><br>
    <b> Privacy:</b><br>
    <font size="-0.5">All the data collected through your participation and that of the other volunteers will be stored on servers located inside the European Union. Accessing the data will not be possible for unauthorized people.
    ...
    Furthermore, this procedure will make your identification impossible also in case results would be published on scientific journals, presented in conferences or in any other public event.
    ...
    materia di protezione dei dati personali') and the European Union Regulation (2016/679 - GDPR). The person responsible for Data Protection is lwy. Valentina Carollo ( <a href="mailto:dpo@sissa.it">dpo@sissa.it</a> or <a href="rpd@sissa.it">rpd@sissa.it</a>. PEC: <a href="protocollo@pec.sissa.it">protocollo@pec.sissa.it</a> ).
