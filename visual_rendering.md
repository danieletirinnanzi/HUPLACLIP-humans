...
1. **Browser check**: first of all we check that the experiment is opened on a supported browser, on a desktop device and that full-screen is supported. This is accomplished through jsPsych browser-check plugin (https://www.jspsych.org/v7/plugins/browser-check/). The subject is redirected to Prolific if these requirements are not met.
...
| 1280×720 (HD)         |           1            | X (zoom 200% resolution 1440; zoom 300% resolution 2160; zoom 400% resolution 2880; zoom 500% resolution 3600) | X (zoom 200% resolution 1440; zoom 300% resolution 2160; zoom 400% resolution 2880; zoom 500% resolution 3600) |      V      | Budget laptops, entry-level screens               |
...
| 2560×1440             |           1            |             X (zoom 200%,  resolution 2880; zoom 300% resolution 4320; zoom 400% resolution 5760)              |             X (zoom 200%,  resolution 2880; zoom 300% resolution 4320; zoom 400% resolution 5760)              |      V      | High-end ultrabooks, gaming laptops               |
...
| 1400x900              |           2            |                            X (zoom 200%, resolution 3600; zoom 50% resolution 900)                             |                            X (zoom 200%, resolution 3600; zoom 50% resolution 900)                             |      V      | MacBook Air (older Retina models)                 |
