...
function generateIntroductionPages() {
    ...
    */
    ...
    During the experiment, you will see images containing two stimuli, and you will have to choose one of them. In the following pages you will receive indications on how to make a choice.
    ...
    You have the possibility to withdraw from the experiment at any moment, without having to provide any explanation. <br><br>
    <font size="+2"><b> Aim of the study: </b></font><br>
    The aim of the study is to investigate humans' ability of solving statistical inference tasks regarding the presence of hidden structures in graphs and matrices.
    <br><br>
    <font size="+2"><b> Privacy: </font></b><br>
    ...
    Go to the next page to visualize the <b>instructions</b> for the experiment. <br><br>
