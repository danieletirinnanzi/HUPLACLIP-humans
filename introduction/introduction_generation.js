...
/* FUNCTION TO CHECK WHETHER THE SUBJECT GAVE CONSENT TO PARTICIPATE IN THE STUDY */
/*
function check_consent(element) {
    /* INPUT: none

    OUTPUT:
    - moving on to the experiment only if subject gave consent, otherwise showing 'alert'
    */ 
   /*
